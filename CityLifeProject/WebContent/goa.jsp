...
<img id=logo src="images/icon.jpg">
 ...
 <%= session.getAttribute("loginId") %></a></li>
  ...
  <div class="col-md-6">
    <h1><b>WELCOME TO GOA</b></h1> 
    
    <p><i>the one place that feels better the more you visit, the only place where you find the real you..</i></p> 
  </div>
  <div class="col-md-6">
 ...
 <figure class="snip1584"><img src="images/goapla.jpg"/>
  <figcaption>
    <h3>Places to see</h3>
    <h5>Monuments Markets Restaurants</h5>
  </figcaption><a href="goadetail.jsp"></a>
</figure>
<figure class="snip1584 hover"><img src="images/goathing.jpg" alt="sample119"/>
  <figcaption>
    <h3>Things to do</h3>
    <h5>Clubs Parks Amusements</h5>
  </figcaption><a href="goadetail1.jsp"></a>
</figure>

<figure class="snip1584"><img src="images/goatrans.jpg" alt="sample120"/>
  <figcaption>
    <h3>Local Transport</h3>
    <h5>Conveyance facilities and rides </h5>
  </figcaption><a href="goadetail2.jsp"></a>
</figure>
...
<figure class="snip1567">
  <img src="images/kr.jpg" alt="sample88" />
  <figcaption>
    <h3>KONKAN RAILWAY ON TRACK</h3>
    <p>Which is worse, that everyone has his price, or that the price is always so low.</p>
  </figcaption>
  <div class="hover"></div><i class="ion-android-add"></i>
  <a href="#"></a>
</figure>
<figure class="snip1567 hover"><img src="images/myg.jpg" alt="sample100" />
  <figcaption>
    <h3>GHUMTANCHE FEST</h3>
    <p>I'm killing time while I wait for life to shower me with meaning and happiness.</p>
  </figcaption>
  <div class="hover"></div><i class="ion-android-add"></i>
  <a href="#"></a>
</figure>
<figure class="snip1567"><img src="images/blog.jpg" alt="sample96" />
  <figcaption>
    <h3>BLOGGING FUTURE</h3>
